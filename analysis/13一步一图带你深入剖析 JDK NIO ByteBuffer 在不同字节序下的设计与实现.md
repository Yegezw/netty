...
本文我们开始 Netty 微观世界系列第一部分的内容，聊聊 Netty 中的网络数据容器 ByteBuf ，对于 ByteBuf 我想大家一定不会陌生，它曾多次出现在前面的系列文章中，比如在[《Netty如何高效接收网络数据 | 一文聊透ByteBuffer动态自适应扩缩容机制》](https://mp.weixin.qq.com/s?__biz=Mzg2MzU3Mjc3Ng==&mid=2247484244&idx=1&sn=831060fc38caa201d69f87305de7f86a&chksm=ce77c513f9004c05b48f849ff99997d6d7252453135ae856a029137b88aa70b8e046013d596e&token=95921803&lang=zh_CN&scene=21#wechat_redirect)和[《一文搞懂Netty发送数据全流程 | 你想知道的细节全在这里》](https://mp.weixin.qq.com/s?__biz=Mzg2MzU3Mjc3Ng==&mid=2247484532&idx=1&sn=c3a8b37a2eb09509d9914494ef108c68&chksm=ce77c233f9004b25a29f9fdfb179e41646092d09bc89df2147a9fab66df13231e46dd6a5c26d&token=95921803&lang=zh_CN&scene=21#wechat_redirect)这两篇文章中提到的 Netty 接收网络数据和发送网络数据时用到的ByteBuf。
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbc9icicNMqk0aziampkZoCeeRM1dnIHGTibSSEWsZKOEO5a3YmTWTfgmtbBwao2ndW8kzRo2JHib8vic7g/640?wx_fmt=png#imgIndex=0)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbc9icicNMqk0aziampkZoCeeRib7cxJ0IJYM9ribP8vwQTAfJF63qhia5ZYYElUBrLjhHTbZUWylNwAPyA/640?wx_fmt=png#imgIndex=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbc9icicNMqk0aziampkZoCeeRsTpdD2otfBzRT0fQFbfW872gibysk9S4vvXVQOJRibOz1CqHic6CIkg3Q/640?wx_fmt=png#imgIndex=2)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbc9icicNMqk0aziampkZoCeeRZUrmnh4ggiaQibdBATicQWdvVh2UloDicwNFNqNU39zo5b78OfNSoTZicpw/640?wx_fmt=png#imgIndex=3)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbc9icicNMqk0aziampkZoCeeRy0KzjsaK17QPqVbD2f7OxYsL0E6rASdVybkBnsQZC4pIYBCJiaibGDqw/640?wx_fmt=png#imgIndex=4)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbc9icicNMqk0aziampkZoCeeRsF5dC8ibp5ZIPh9t6EecvvtMEoicamyTzyQgpMMeqA2vDThKy86Rjvbg/640?wx_fmt=png#imgIndex=5)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbc9icicNMqk0aziampkZoCeeRib7cxJ0IJYM9ribP8vwQTAfJF63qhia5ZYYElUBrLjhHTbZUWylNwAPyA/640?wx_fmt=png#imgIndex=6)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbc9icicNMqk0aziampkZoCeeRUWsOuvFgGEQZDjMjmfhlLgFGbPqPEkSlCvel8dCOvCicNdrxUh1btSg/640?wx_fmt=png#imgIndex=7)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbc9icicNMqk0aziampkZoCeeRXIQdUMZDhJ5s43Wz3XWQKaGu9e4rUfKZgb50vfFPApQib6zQ1EynZAw/640?wx_fmt=png#imgIndex=8)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbc9icicNMqk0aziampkZoCeeRaFylliaAS1yOQQPwiboU7XgNDJT6EocFBmXljIurKvA4h7L8LXtt5aVA/640?wx_fmt=png#imgIndex=9)

clear方法的问题.png

针对这种情况，我们就不能简单粗暴的设置 position 指针了，为了保证未读取的数据部分不被覆盖，我们就需要先将不可覆盖的数据部分移动到 Buffer 的最前边，然后将 position 指针指向可覆盖数据区域的第一个位置。

![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbc9icicNMqk0aziampkZoCeeRmhsrEJCHU4npSyvR1MFPsvG6mGFD37SRC1mKFkIFjPScn0mCGf7BgA/640?wx_fmt=png#imgIndex=10)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbc9icicNMqk0aziampkZoCeeRHfvnrfU6cggEt77poDoUuczheWvFFKOvoDDwetshOmvCspjq0lVmrg/640?wx_fmt=png#imgIndex=11)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbc9icicNMqk0aziampkZoCeeRib7cxJ0IJYM9ribP8vwQTAfJF63qhia5ZYYElUBrLjhHTbZUWylNwAPyA/640?wx_fmt=png#imgIndex=12)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbc9icicNMqk0aziampkZoCeeRYVnjiaW4GkxzIdsBQH2iadLKr7UYQcZ0ibpicibar46zy2ZNeHQJGZYNNzg/640?wx_fmt=png#imgIndex=13)Buffer视图.png
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbc9icicNMqk0aziampkZoCeeRib7cxJ0IJYM9ribP8vwQTAfJF63qhia5ZYYElUBrLjhHTbZUWylNwAPyA/640?wx_fmt=png#imgIndex=14)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbc9icicNMqk0aziampkZoCee