...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrGvtTrBQnwUILUgN2L3QHuS0VPeYo81EZ4ARbZIk8XE1EhbQ5eeKRIWQ/640?wx_fmt=png#imgIndex=0)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrGd9ogiaOzR3Shja7LfpoxWmdBpNVYl2F7icKibkkMOIAibLMERkLN0RibdZg/640?wx_fmt=png#imgIndex=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrGIibiaCKAOudiaibMQImHLhiaTtcds7hmsOicYiaREXYGbYbDRRqVBSibczGlyQ/640?wx_fmt=png#imgIndex=2)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrGsn4fFaBGsA3Qib2QmxiaehIiaic7HZgR7ibVQKMLmY0ul012J2ic3I44Pr5A/640?wx_fmt=png#imgIndex=3)

Reactor启动后的结构.png

随后紧接着我们在[?《Netty如何高效接收网络连接》](https://mp.weixin.qq.com/s?__biz=Mzg2MzU3Mjc3Ng==&mid=2247484184&idx=1&sn=726877ce28cf6e5d2ac3225fae687f19&chksm=ce77c55ff9004c493b592288819dc4d4664b5949ee97fed977b6558bc517dad0e1f73fab0f46&scene=21#wechat_redirect)一文中详细介绍了Netty高效接收客户端网络连接的全流程，在这里Netty的核心重要组件NioServerSocketChannel开始正是登场，在NioServerSocketChannel中我们创建了客户端连接NioSocketChannel，并详细介绍了NioSocketChannel的初始化过程，随后通过在NioServerSocketChannel的pipeline中触发ChannelRead事件，并最终在ServerBootstrapAcceptor中将客户端连接NioSocketChannel注册到Sub Reactor中开始监听客户端连接上的OP\_READ事件，准备接收客户端发送的网络数据也就是本文的主题内容。

![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrG4VjAOuTOk3AZEaMjRr5Nic1lcqfveccplt3JV7xuSOia6nmdDUxSBm7A/640?wx_fmt=png#imgIndex=4)

image.png

自此Netty的核心组件全部就绪并启动完毕，开始起飞~~~

![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrGlNLu4Gz0GYUTUwHpD4gEbvGZ5XxPiaj7yy6S3B42gibfPIm5s5Sjeg0w/640?wx_fmt=png#imgIndex=5)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrGJCjQJqYs13qZfBceLVWKYiaQBw4Y6jp79WthNSdbb2cNlibR7dNnKBag/640?wx_fmt=png#imgIndex=6)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrGoWEDovD5yg49Nvib8Y7RaFnScr32bstk1hMXzHVJLeJVKic1NBiaL4WXA/640?wx_fmt=png#imgIndex=7)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrGYyBIUicibrk3HmtYc62Cv6RsibibmJq3Eodcc0e9nKVgWMpbCCsDDCLEOA/640?wx_fmt=png#imgIndex=8)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrGfibQsR56zWLPELzS8Qzmd9WSStNcFW3cZH2MshayiaibHLrEaYkJ3Fh9A/640?wx_fmt=png#imgIndex=9)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrGIVkg8MfIf9iaV0yWia4J1yJnnmftH3Wjr4piaPCB07ygaMAArjt2ThPxA/640?wx_fmt=png#imgIndex=10)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrGWBicFxia3JO0wJK92SmSfYk1UMNI259RlnpFevY0c80O6yg72ylA0k7A/640?wx_fmt=png#imgIndex=11)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrGYyBIUicibrk3HmtYc62Cv6RsibibmJq3Eodcc0e9nKVgWMpbCCsDDCLEOA/640?wx_fmt=png#imgIndex=12)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrG3jevzq4hSk3pCq5N8bmYZZ4tEm3TxibLgX2vl3Jd1NNXuibqEOTP4bPw/640?wx_fmt=png#imgIndex=13)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrG8L1T8GChJBTnGroCOq8CJzl54EIS6bQ4qAz75UB39eObvPOoibs39Gw/640?wx_fmt=png#imgIndex=14)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrGcw8uiaXnDMx2vbhq8DIHRkc3jJE5jibSXI8MNSL9I8FYOasQ3Fj3tiaxQ/640?wx_fmt=png#imgIndex=15)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrGGiaD1l3ZRb3bNvREda7elgxDI6ajaPrhaxZKSbgzrrcfZAnswA0wgCA/640?wx_fmt=png#imgIndex=16)
...
*   `respectMaybeMoreData = true`表示要对可能还有更多数据进行处理的这种情况要`respect`认真对待,如果本次循环读取到的数据已经装满`ByteBuffer`，表示后面可能还有数据，那么就要进行读取。如果`ByteBuffer`还没装满表示已经没有数据可读了那么就退出循环。![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrGbBu9RicDUiaypMPImoK73BeSbpCtoF3KrKcxrfj72P9fYJpMyY27nqBw/640?wx_fmt=png#imgIndex=17)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrG2Y9gicLCgtQnKuLvRCK8lleZe9ud2uqzadHpe0svAT9PE1qpbIZyYDA/640?wx_fmt=png#imgIndex=18)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrGribWL9cEYdfyia6QiaJQQSiaufcvG4sLqktYYMbpOQ3HSNg8GXPkzs39nw/640?wx_fmt=png#imgIndex=19)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/sOIZXFW0vUbsJJoRlck3EIX1zd6sgNrGribWL9cEYdfyia6QiaJQQSiaufcvG4sLqktYYMbpOQ3HSNg8GXPkzs39nw/640?wx_fmt=png#imgIndex=20)

image.png

#### 4.4.1 缩容

*   如果本次`OP_READ事件`实际读取到的总字节数`actualReadBytes`在SIZE\_TABLE\[index - INDEX\_DECREMENT\]与SIZE\_TABLE\[index\]之间的话，也就是如果本轮read loop结束之后总共读取的字节数在`[1024,2048]`之间。说明此时分配的`ByteBuffer`容量正好，不需要进行缩容也不需要进行扩容。比如本次`actualReadBytes = 2000`，正好处在`1024`与`2048`之间。说明`2048`的容量正好。
